...
* This will be a lot easier. Open RStudio, go to the "Console" window in
  ...
  library(pacman)
  p_install(tidyverse, coda, mvtnorm, daggity, shiny, shinystan,
  for (p in c("tidyverse", "coda", "mvtnorm", "dagitty", "shiny", "shinystan",
              "bayesplot", "brms", "rprojroot", "rmarkdown", "knitr", "ape",
              "broom", "sf", "flextable", "ggdag", "ggmcmc", "ggrepel",
              "ggthemes", "loo", "patchwork", "psych", "rcartocolor", "Rcpp",
              "statebins", "tidybayes", "viridis", "viridisLite",
              "wesanderson")) {
